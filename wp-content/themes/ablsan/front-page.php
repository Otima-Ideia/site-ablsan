        ...
        <section class="row ablsan-row-infos">
            <article class="col-lg-8">
                <div class="headline-title">
                    <hr class="red">
                    <h2 class="headline headline-margin">A ABLSAN</h2>
                </div>
            ...
            <aside class="col-lg-4">
                <article class="col-lg" style="position: relative;">
                    <div class="headline-title front-page-infos">
                        <hr class="red">
...
<div class="container-fluid" style="background-color: #ebebeb;">
    <section style="display: flex; justify-content: center;">
        <article style="background-image: url('https://homologacao.ablsandigital.com.br/wp-content/themes/ablsan/assets/img/Imagem1-2.png'); background-size: cover;" class="row unitah-infos">
            <div class="col-lg-4">
                <p class="unitah-item-info">Mais de <span style="font-size: 2.5rem;">2000</span><br><span style="font-size: .75rem;">Lojas comercializadas</span></p><a href="" class="btn btn-enviar" style="margin-bottom: 1.75rem;/*! justify-content: center; */font-size: .85rem; visibility: hidden;">Entre em contato</a>
            </div>
            <div class="col-lg-4">
                <p class="unitah-item-info">Mais de <span style="font-size: 2.5rem;">50</span><br><span style="font-size: .75rem;">Shoppings Comercializadas</span></p><a href="" style="margin-bottom: 1.75rem;/*! justify-content: center; */font-size: .85rem;" class="btn btn-light">Assista ao vídeo</a>
            </div>
            <div class="col-lg-4">
                <p class="unitah-item-info">Mais de <span style="font-size: 2.5rem;">30</span><br><span style="font-size: .75rem;">Shoppings em comercialização</span></p><a href="" class="btn btn-enviar" style="margin-bottom: 1.75rem;/*! justify-content: center; */font-size: .85rem; visibility: hidden;">Entre em contato</a>
            </div>
        </article>
    </section>
</div>
